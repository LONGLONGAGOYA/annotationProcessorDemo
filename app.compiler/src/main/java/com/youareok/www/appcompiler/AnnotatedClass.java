package com.youareok.www.appcompiler;
...
public class AnnotatedClass {
    private static class TypeUtil {
        static final ClassName BINDER = ClassName.get("com.youareok.www.api", "ViewBinder");
        static final ClassName PROVIDER = ClassName.get("com.youareok.www.api", "ViewFinder");
    }
